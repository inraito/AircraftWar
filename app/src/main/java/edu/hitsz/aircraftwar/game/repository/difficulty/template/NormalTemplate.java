...
@Singleton
public class NormalTemplate extends BaseTemplate{
    @Inject
    public NormalTemplate(GameAssetsManager manager, GameEventBus eventBus, GameAudioManager audioManager) {
    ...
    private final int mobSpawnThreshold = 700;
    private int mobSpawnCount = 0;
    private final int eliteSpawnThreshold = 1300;
    ...
    private final int heroShootThreshold = 900;
    private int heroShootCount = 0;
    private final int enemyShootThreshold = 700;
    ...
    private final int bossSpawnThreshold = 300;
